...
console.log(arrayMadness([3, 5, 6], [7, 2, 4]));
...
console.log(differenceInAges([45, 33, 67, 34]));
...
console.log(positiveSum([44, 33, 53, 23]));
...
console.log(correctPolishLetters('ddd'));
...
console.log(correctPolishLetters2('ddd'));
...
function correctPolishLetters3(string) {
  return string
    .split('')
    .map((c) => polishLetters[c] || c)
    .join('');
}
console.log(correctPolishLetters3('ddd'));
...
console.log(countingValleys('FFFUUDFF'));
...
console.log(findMiddle('52dsdf345afd5'));
...
console.log(solution('33333254532'));
...
console.log(consecutiveDucks(3432452));
